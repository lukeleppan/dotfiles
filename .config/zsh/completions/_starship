...
'-h[Print help]' \
'--help[Print help]' \
'::name -- The name of preset to be printed:(no-runtime-versions bracketed-segments plain-text-symbols no-empty-icons tokyo-night no-nerd-font pastel-powerline pure-preset nerd-font-symbols)' \
&& ret=0
;;
(print-config)
_arguments "${_arguments_options[@]}" \
